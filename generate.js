...
module.exports = async (parm) => {
  ...
  if (type === 'quote') {
    ...
    canvasPicCtx.fillText('@KenshiroBot', canvasPic.width - 25, canvasPic.height - 25)
    ...
    const canvasPatternImage = await loadImage(path.join(__dirname, 'assets', 'pattern_02.png'));
    ...
    canvasPicCtx.fillText('@KenshiroBot', 0, 0)
